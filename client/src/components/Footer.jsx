  ...
  return (
    <>
        <style>{`
            ...
            <footer className="flex flex-col items-center justify-center w-full py-10 bg-gradient-to-b from-[#0fc2b3] to-[#114f83] text-white/70">
            <a href="/" className="flex items-center">
                ...
                <p className="mt-4 text-center">{t('copyrightNotice')}</p>
                <div className="flex items-center gap-4 mt-5">
                    <a href="https://www.linkedin.com/in/ahmed-alawlaqi-dev/" target="_blank" rel="noopener noreferrer" className="hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <a href="https://x.com/Ahmed_k247" target="_blank" rel="noopener noreferrer" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://github.com/ahmed-alawlaqi25" target="_blank" rel="noopener noreferrer" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
